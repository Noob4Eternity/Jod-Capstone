      ...
      <div
        ...
        <div
          ...
          {(() => {
            ...
            const defaultLayers = ["var(--menu-layer-1)", "var(--menu-layer-2)"];
            const raw = colors && colors.length ? colors.slice(0, 4) : defaultLayers;
            let arr = [...raw];
            if (arr.length >= 3) {
          ...
          <button
            ...
            <span
              ...
              <span
                ...
                {textLines.map((l, i) => (
                  <span
                    className="sm-toggle-line text-primary block h-[1em] leading-none"
                    key={i}>
                    {l}
                  </span>
                ))}
            ...
            <span
              ref={iconRef}
              className="sm-icon text-primary relative w-[14px] h-[14px] shrink-0 inline-flex items-center justify-center [will-change:transform]"
              aria-hidden="true">
              <span
                ref={plusHRef}
          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div
                ...
                <h3
                  className="sm-socials-title m-0 font-medium"
...
.sm-scope .sm-toggle:focus-visible { outline: 2px solid var(--menu-accent); outline-offset: 4px; border-radius: 4px; }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid var(--menu-accent); outline-offset: 3px; }
...
.sm-scope .sm-socials-link:hover { color: var(--menu-item-hover); }
...
.sm-scope .sm-panel-item:hover { color: var(--menu-item-hover); }
.sm-scope .sm-panel-list[data-numbering] { counter-reset: smItem; }
.sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { counter-increment: smItem; content: counter(smItem, decimal-leading-zero); position: absolute; top: 0.1em; right: 3.2em; font-size: 18px; font-weight: 400; color: var(--menu-accent); letter-spacing: 0; pointer-events: none; user-select: none; opacity: var(--sm-num-opacity, 0); }
