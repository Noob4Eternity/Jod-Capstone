...
import { useThemeToggle } from "./skiper";
...
export const ThemeToggleButton2 = ({ className = "" }: { className?: string }) => {
  const { isDark, toggleTheme } = useThemeToggle({
    variant: "circle", // or your preferred variant
    start: "center",   // or your preferred start position
  });
  ...
  return (
    <button
      ...
      onClick={toggleTheme}> {/* Use toggleTheme instead of local state */}
      <svg
        xmlns="http://www.w3.org/2000/svg"
        aria-hidden="true"
        fill="currentColor"
