...
export const KanbanBoard: React.FC<{ projectId?: string }> = ({ projectId }) => {
  ...
  const getStatusColor = (statusName: string): string => {
    switch (statusName.toLowerCase()) {
      case 'to do': return 'kanban-todo';
      case 'in progress': return 'kanban-in-progress';
      case 'in review': return 'kanban-review';
  ...
  return (
    <div className="h-screen bg-background flex flex-col">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-ring bg-background text-foreground w-64"
              />
            </div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-8 py-2 border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-ring appearance-none bg-background text-foreground"
              >
      ...
      <div className="flex-1 overflow-x-auto overflow-y-hidden">
        <div className="flex gap-6 p-6 h-full min-w-max items-center justify-center">
          {columns
